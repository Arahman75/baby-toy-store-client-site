        ...
        <div className='p-4 bg-base-200 mt-12'>
            <footer className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <aside>
                    ...
                    <p className='text-2xl font-semibold pt-2 lg:text-start text-center'>Baby Toy Store</p>
                </aside>
            ...
            <p className='text-center'>All content reserved 2024 copy right by Abdur Rahman</p>
        </div>
    );
};
